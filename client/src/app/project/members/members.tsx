...
const members: Member[] = [
  { id: '@zunith', name: 'Zuna G.', role: 'Owner', jobs: 8, lastSeen: 'Today', rewards: '1,200 CTX', thumbnail: 'https://picsum.photos/id/1084/100/300?grayscale' },
  { id: '@Aleez87', name: 'Ali Muzammal', role: 'Contributor', jobs: 12, lastSeen: 'This week', rewards: '800 CTX', thumbnail: 'https://picsum.photos/id/1075/100/300?grayscale' },
  { id: '@Armanik98', name: 'Armand L.', role: 'Contributor', jobs: 1, lastSeen: 'This week', rewards: '250 CTX', thumbnail: 'https://picsum.photos/id/1035/100/300?grayscale' },
  { id: '@AnnCapistrano', name: 'Ann Capistrano', role: 'Contributor', jobs: 3, lastSeen: '1 month ago', rewards: '270 CTX', thumbnail: 'https://picsum.photos/id/1000/100/300?grayscale' }
];
          ...
          { members.map((member): JSX.Element => (
            <tr className="cm-table__tr" key={member.id}>
              <td className="cm-table__td">
                <img src={member.thumbnail} alt={member.name} className="user-thumb rounded-circle"/>
              </td>
